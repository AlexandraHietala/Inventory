...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CollectionApi", Version = "v1.0", Description = "API for managing collections.", Contact = new OpenApiContact { Name = "Alexandra Hietala", Email = "alexandra@starryeden.com" } });
