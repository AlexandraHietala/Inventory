...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "SeriesApi", Version = "v1.0", Description = "API for managing series.", Contact = new OpenApiContact { Name = "Alexandra Hietala", Email = "alexandra@starryeden.com" } });
