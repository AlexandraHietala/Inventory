...
BEGIN
	...
	INSERT INTO [hist].[Audit_Items] (EFFECTIVE_DATE,INEFFECTIVE_DATE,ID,STATUS,TYPE,BRAND_ID,SERIES_ID,NAME,DESCRIPTION,FORMAT,SIZE,YEAR,PHOTO,ADDED,DELETED,CREATED_BY,CREATED_DATE,LAST_MODIFIED_BY,LAST_MODIFIED_DATE) 
	VALUES (DATEADD(ms, 10,GETDATE()),GETDATE(),@ID,@STATUS,@TYPE,@BRAND_ID,@SERIES_ID,@NAME,@DESCRIPTION,@FORMAT,@SIZE,@YEAR,@PHOTO,0,1,@CREATED_BY,@CREATED_DATE,@LAST_MODIFIED_BY,@LAST_MODIFIED_DATE); 		  
END
...
BEGIN
	...
	INSERT INTO [hist].[Audit_Items] (EFFECTIVE_DATE,INEFFECTIVE_DATE,ID,STATUS,TYPE,BRAND_ID,SERIES_ID,NAME,DESCRIPTION,FORMAT,SIZE,YEAR,PHOTO,ADDED,DELETED,CREATED_BY,CREATED_DATE,LAST_MODIFIED_BY,LAST_MODIFIED_DATE) 
	VALUES (GETDATE(),NULL,@ID,@STATUS,@TYPE,@BRAND_ID,@SERIES_ID,@NAME,@DESCRIPTION,@FORMAT,@SIZE,@YEAR,@PHOTO,1,0,@CREATED_BY,@CREATED_DATE,@LAST_MODIFIED_BY,@LAST_MODIFIED_DATE); 		  
END
...
BEGIN
	...
	INSERT INTO [hist].[Audit_Items] (EFFECTIVE_DATE,INEFFECTIVE_DATE,ID,STATUS,TYPE,BRAND_ID,SERIES_ID,NAME,DESCRIPTION,FORMAT,SIZE,YEAR,PHOTO,ADDED,DELETED,CREATED_BY,CREATED_DATE,LAST_MODIFIED_BY,LAST_MODIFIED_DATE) 
	VALUES (GETDATE(),NULL,@ID,@STATUS,@TYPE,@BRAND_ID,@SERIES_ID,@NAME,@DESCRIPTION,@FORMAT,@SIZE,@YEAR,@PHOTO,0,0,@CREATED_BY,@CREATED_DATE,@LAST_MODIFIED_BY,@LAST_MODIFIED_DATE);
END
