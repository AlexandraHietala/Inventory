...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ItemApi", Version = "v1.0", Description = "API for managing items.", Contact = new OpenApiContact { Name = "Alexandra Hietala", Email = "alexandra@starryeden.com" } });
