...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "UserApi", Version = "v1.0", Description = "API for managing user accounts, roles, and authentication.", Contact = new OpenApiContact { Name = "Alexandra Hietala", Email = "alexandra@starryeden.com" } });
