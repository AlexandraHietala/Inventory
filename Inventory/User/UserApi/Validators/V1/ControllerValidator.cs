...
{
    public interface IControllerValidatorV1
    {
    ...
    public class ControllerValidatorV1 : IControllerValidatorV1
    { 
        ...
        public string ValidateId(int id)
        {
            ...
            if (id == 0)
                failureList.Add(new ValidationFailure() { Code = 100200027, Message = "Id is invalid." });

            if (id < 0)
                failureList.Add(new ValidationFailure() { Code = 100200028, Message = "Id is invalid." });

            if (id > 99999)
                failureList.Add(new ValidationFailure() { Code = 100200029, Message = "Id is invalid." });
